...
class Issue(DataclassSerializer):  # pylint: disable=too-many-instance-attributes
    ...
    original: Dict[str, Any] = field(init=False, default_factory=dict, metadata={'serialize': False})
    ...
    def __post_init__(self):
        '''
        Special dataclasses dunder method called automatically after Issue.__init__
        '''
