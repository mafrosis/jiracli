...
@mock.patch('jira_cli.main.write_config')
@mock.patch('jira_cli.main.tqdm')
def test_pull_issues_calls__connect(mock_tqdm, mock_write_config, mock_jira):
    """
...
@mock.patch('jira_cli.main.write_config')
@mock.patch('jira_cli.main.tqdm')
def test_pull_issues_last_updated_field_creates_filter_query(mock_tqdm, mock_write_config, mock_jira):
    """
...
@mock.patch('jira_cli.main.write_config')
@mock.patch('jira_cli.main.tqdm')
def test_pull_issues_last_updated_field_causes_filter_from_waaay_back(mock_tqdm, mock_write_config, mock_jira):
    """
...
@mock.patch('jira_cli.main.write_config')
@mock.patch('jira_cli.main.tqdm')
def test_pull_issues_write_issues_and_config_called(mock_tqdm, mock_write_config, mock_jira):
    """
    Test write_issues method is called
    Test write_config function is called
    """
    mock_jira._jira.search_issues.side_effect = [mock.Mock(total=1), []]
...
@mock.patch('jira_cli.main.write_config')
@mock.patch('jira_cli.main.tqdm')
def test_pull_issues_adds_issues_to_self(mock_tqdm, mock_write_config, mock_jira):
    """
